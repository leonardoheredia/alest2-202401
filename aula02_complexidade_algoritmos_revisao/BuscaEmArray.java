...
public class BuscaEmArray {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < QTD_TESTES; i++) {
            int numero = geradorRandomico.nextInt(100);
            ...
            //System.out.printf("%n%d",arrayNumerosOrdenado[i]);


        }

        for (int i = 0; i < QTD_TESTES; i++) System.out.println(arrayTestesNaoOrdenado[i]);
